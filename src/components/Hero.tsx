      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="space-y-8 text-center lg:text-left">
          ...
          <div ref={ctaRef}>
            <Button
              size="lg"
              className="group relative overflow-hidden bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:scale-105 transition-transform duration-300 glow-box px-8 py-6 text-lg"
            >
        ...
        {/* Right: Spline 3D */}
        <div ref={splineRef} className="relative h-[500px] lg:h-[600px]">
          <iframe
            src="https://my.spline.design/orb-m5KSbPJiTDXdujpgjzBsnq9S/"
