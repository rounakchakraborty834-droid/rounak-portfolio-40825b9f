...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      gsap.to(splineRef.current, { x, y, duration: 0.5, ease: "power2.out" });
    };
  ...
  return (
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-background via-background to-muted/30">
      {/* Floating particles */}
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10 py-20">
        ...
        <div className="space-y-6 text-center lg:text-left">
          ...
          <div ref={subtitleRef} className="text-3xl md:text-4xl lg:text-5xl font-semibold text-foreground/70">
            <TypewriterEffect
              words={["Web Developer", "UI/UX Designer", "Creative Coder", "Full-Stack Dev"]}
              typingSpeed={90}
              deletingSpeed={50}
              pauseTime={2000}
            />
